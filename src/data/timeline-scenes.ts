...
export const TIMELINE_SCENES: TimelineScene[] = [
  ...
  },
  {
    ...
    bodyParagraphs: [
      ...
      `Efekt jest gigantyczny. Tysiące firm amerykańskich — od Microsoftu po małe aplikacje mobilne — opierały swoje transfery danych o Safe Harbor. Trzeba stworzyć nowy framework. Negocjacje trwają pół roku. Nowy framework — „Privacy Shield" — wchodzi w życie w lipcu 2016 roku. Schrems natychmiast składa kolejną skargę. Po pięciu latach zakończy się ona orzeczeniem „Schrems II" (lipiec 2020) — Privacy Shield również zostanie unieważniony.`,
  ...
  },
  {
    ...
    bodyParagraphs: [
      ...
      "RODO to rzadkość: europejska regulacja, która staje się globalnym standardem. Kalifornia przyjmuje CCPA w 2018 roku — wzorowaną na RODO. Brazylia — LGPD w 2020. Indie — DPDP w 2023. Chiny mają własny PIPL z 2021. Każde z tych praw ma inne detale. Każde wywodzi się z RODO.",
  ...
  },
  {
    ...
    bodyParagraphs: [
      ...
      `W tle dzieje się coś jeszcze. 19 lutego 2017 roku Susan Fowler, była inżynierka Ubera, publikuje na swoim blogu tekst „Reflecting on one very, very strange year at Uber". Opisuje systemowy seksizm, molestowanie i to, jak HR sprawy tuszowała. Tekst rozchodzi się błyskawicznie. W czerwcu 2017 roku Travis Kalanick — założyciel i prezes — zostaje zmuszony do ustąpienia. Pięć miesięcy później Uber ujawnia, że w 2016 roku haker wykradł dane 57 milionów klientów i kierowców — a firma po cichu zapłaciła mu 100 tysięcy dolarów, żeby sprawę zatuszować.`,
      ...
      `W 2019 roku Equifax zawiera ugodę: 575 milionów dolarów (z możliwością podwyższenia do 700 milionów). Sygnatariusze: FTC, kilka stanów, CFPB. Najwyższa ugoda w sprawie wycieku danych w historii USA. Klientom zaoferowano „dożywotni monitoring kredytowy". Kwota gotówkowa: 125 dolarów na osobę. W praktyce FTC wypłaciło przeciętnie 6,90 dolara — fundusz został szybko wyczerpany.`,
  ...
  },
  {
    ...
    bodyParagraphs: [
      ...
      `W tym samym roku — pandemia. W marcu 2020 Zoom rośnie z 10 milionów uczestników dziennie do 300 milionów w kwietniu. Marketing firmy chwali się szyfrowaniem „end-to-end". 1 kwietnia 2020 roku Bill Marczak z Citizen Lab publikuje analizę techniczną: szyfrowania end-to-end Zoom nie ma. Klucze są generowane na serwerach Zooma, część ruchu przechodzi przez centra danych w Chinach. FBI wydaje ostrzeżenie przed „zoombombingiem" — nieproszeni uczestnicy wchodzą na spotkania i pokazują pornografię albo obrazy obraźliwe.`,
  ...
  },
  {
    ...
    bodyParagraphs: [
      "5 października 2021 roku Frances Haugen zeznaje przed Senatem USA. Ma 37 lat, jest absolwentką Harvard Business School, byłą product managerką w zespole Civic Integrity w Facebooku. Zeznaje przez dwie godziny. W dłoni trzyma teczkę kopert — wewnętrzne dokumenty Facebooka, które wyniosła, zanim firma zamknęła ten dział w grudniu 2020 roku.",
      `Dokumenty — około 22 tysięcy stron — zostały ujawnione w serii „Facebook Files" publikowanej przez „Wall Street Journal" od września 2021 roku (autor: Jeff Horwitz). Najważniejsze ustalenia: Facebook od lat wiedział, że Instagram szkodzi psychice nastolatek (wewnętrzne badania pokazały, że 32 procent dziewcząt czujących się źle z własnym ciałem czuje się po Instagramie jeszcze gorzej). Facebook miał program „XCheck" (cross-check), który wyłączał moderację dla 5,8 miliona „użytkowników VIP". Algorytm News Feed od 2018 roku był optymalizowany pod „meaningful social interactions" — w praktyce promował treści gniewne i polaryzujące.`,
      ...
      "W listopadzie 2021 roku WhatsApp, spółka Mety, dostaje 225 milionów euro kary od irlandzkiego DPC za naruszenia obowiązku transparencji. Sierpień 2021 — Apple ogłasza plan skanowania zdjęć na urządzeniach klientów pod kątem CSAM (Child Sexual Abuse Material). Kryptograf Matthew Green i Electronic Frontier Foundation protestują: to precedens, który w innych rękach może posłużyć do szpiegowania dysydentów. Apple wycofuje plan po trzech tygodniach.",
      `Rok 2021 to także rok, w którym Frances Haugen mówi publicznie coś, co wielu podejrzewało, ale nikt z wewnątrz firmy nie potwierdził: „Facebook stawia zysk ponad bezpieczeństwo. Wielokrotnie. Systemowo". To nie jest anegdota. To wzorzec, udokumentowany własnymi dokumentami firmy. Debata o regulacji się zmienia — ale zmienia się też w wymiarze politycznym. Wcześniej firmy technologiczne były traktowane jak „coś, co należy wspierać". Od 2021 roku są traktowane jak „coś, co należy regulować".`,
    ],
    caseIds: ["A05", "C03"],
    highlights: [
  ...
  },
  {
    ...
    bodyParagraphs: [
      ...
      "W międzyczasie Musk przekształca Twittera w X. W lipcu 2023 roku zmienia logo. Niebieski ptaszek znika. Algorytm wyświetla więcej treści kont płatnych (Twitter Blue, potem X Premium). Niezależni badacze tracą dostęp — wielu korzystało z wygaszonego API. Moderacja staje się wybiórcza. Treści antysemickie, spiskowe, seksistowskie wracają do feedu.",
  ...
  },
  {
    ...
    bodyParagraphs: [
      ...
      `Meta zapowiada apelację. Ale fundamentalnie nie ma już jak się bronić. Transfer do USA w dotychczasowej formie jest nielegalny. Firmy europejskie muszą albo trzymać dane w Europie (drogie), albo czekać na nowy framework — Data Privacy Framework wchodzi w lipcu 2023 i Schremsowe NOYB już zapowiada skargę „Schrems III".`,
  ...
  },
  {
    ...
    bodyParagraphs: [
      ...
      "Sierpień 2024. xAI — firma Elona Muska — uruchamia Grok Imagine. Generator obrazów wbudowany w X (dawnego Twittera). Produkt nie ma filtrów bezpieczeństwa typowych dla DALL-E czy Midjourney. W ciągu kilku dni w sieci pojawiają się deepfake'i: Taylor Swift w sytuacjach seksualnych, politycy w kompromitujących pozach, fałszywe sceny przemocy. Irlandzki DPC wszczyna postępowanie. Komisja Europejska — pod kątem DSA (Digital Services Act) — także. Grok Imagine dodaje filtry we wrześniu 2024 roku, pod presją.",
  ...
  },
  {
    ...
    bodyParagraphs: [
      ...
      "W kwietniu 2025 roku Komisja Europejska nałożyła pierwszą w historii karę DMA: na Metę, 200 milionów euro. Apple — 500 milionów za nadużycia antykonkurencyjne w App Store. W maju — 530 milionów euro dla TikToka za transfery danych do Chin. W sierpniu — propozycja 120 milionów euro dla X za deepfake'i Grok Imagine.",
